...
export const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    problem: 'Australian residential construction compliance is complex and error-prone',
    description: 'AI construction intelligence platform for Australian residential building. Automated NCC compliance checking, AI-powered design optimisation, agentic cost estimation, and enhanced RAG with cross-validation. Built for builders, by builders.',
